...
export const PRODUCTS: Product[] = [
  {
    ...
    repositoryUrl: "https://github.com/fgalyasz/SnappyZones",
    supportEmail: "hello@tenprintsoftware.com",
    version: "1.3.5",
    downloadUrl: "https://github.com/fgalyasz/SnappyZones/releases/latest/download/SnappyZones.dmg",
    downloadFallbackUrl: "https://github.com/fgalyasz/SnappyZones/releases/latest",
    packageFormat: "DMG",
  ...
  },
  {
    ...
    supportEmail: "hello@tenprintsoftware.com",
    version: "1.1.1",
    downloadUrl: "https://github.com/fgalyasz/SessionGuard/releases/latest/download/SessionGuard.dmg",
    downloadFallbackUrl: "https://github.com/fgalyasz/SessionGuard/releases/latest",
    packageFormat: "DMG",
    requirements: "macOS 13 Ventura+",
  ...
  },
  {
    ...
    supportEmail: "hello@tenprintsoftware.com",
    version: "0.1.15",
    downloadUrl: "https://github.com/fgalyasz/WalkAway/releases/latest/download/WalkAway.dmg",
    downloadFallbackUrl: "https://github.com/fgalyasz/WalkAway/releases/latest",
    packageFormat: "DMG",
    requirements: "macOS 13 Ventura+",
    categoryKey: "category.session",
    model: "free",
